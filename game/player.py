"""Модуль player - класс игрока, управляемого пользователем.

Содержит класс Player с реализацией физики прыжка, неуязвимости,
анимаций и управления для главного персонажа игры.
"""
...
class Player(BaseObject):   # Класс игрока, управдяемого пользователем
    ...
    def __init__(self, x, y, width=90, height=120):    # Инициализация игрока
        ...
        Args:
            ...
            y (int): Начальная координата Y (уровень земли).
            width (int): Ширина игрока. По умолчанию 90.
            height (int): Высота игрока. По умолчанию 120.
        """
    ...
    def update_invulnerability(self, dt):
        """Обновляет состояние неуязвимости игрока.
    ...
    def draw(self, screen):
        """Отрисовывает игрока с учетом неуязвимости.
